...
public class TestJavaMail {
	public static void main(String[] args) {
        ...
        mb.setUsername("871889325@qq.com"); // 设置发件人邮箱的用户名
        mb.setPassword("lvogbhpaojeubaid"); // 设置发件人邮箱的密码，需将*号改成正确的密码
        mb.setFrom("871889325@qq.com"); // 设置发件人的邮箱
        mb.setTo("2641065994@qq.com"); // 设置收件人的邮箱
